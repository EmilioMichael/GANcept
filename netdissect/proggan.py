...
def state_dict_from_old_pt_dict(params):
    ...
    # # output_256x256.conv.weight
    # # output_256x256.wscale.b
    
    # # result['%s.conv.weight' % pt_layername] = params['%s.conv.weight' % pt_layername]
    # # result['%s.wscale.b' % pt_layername] = params['%s.wscale.b' % pt_layername]

    result['%s.conv.weight' % pt_layername] = params['output_256x256.conv.weight']
    result['%s.wscale.b' % pt_layername] = params['output_256x256.wscale.b']
